...
var whatsapp = store.get("wa1")
var code = store.get("code")
...
serial.get((error,serial)=>{
        let UniqMachineId = store.get("kode_registrasi");
...
// document.getElementById("kode").value = xMID
    ...
    if (button) {
        ...
        macaddress.one(function(err,mac){
            ...
            let UniqMachineId = code + mac.replaceAll(':', '').substr(0, 8).toUpperCase();
            let userInfo = {
                code: UniqMachineId,
                serial: getSerial,
              };
