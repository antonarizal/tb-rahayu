function openSupplier() {
  ...
  const config_kategori = {
    ...
    grid_mode: {
      ...
      //         //alert(get_sel.nama_supplier)
      //         $("#supplier").val(get_sel.nama_supplier);
      //         $("#id_supplier").val(get_sel.recid);
      //         w2popup.close()
      //     }
          ...
          render(record, extra) {
            if (mode == "supplier") {
              var html =
                ...
                '\',\''+record.idsupp+'\')" ><i class="fa fa-check"></i> pilih</button>';
            } else {
              var html =
