...
var config_barang = {
  grid: {
    ...
    header: header,
    url: {
      get : api_url + "api/pembelian/all",
      remove : api_url + "api/pembelian/remove",
    },
    method: "GET",
    reorderRows: false,
    autoLoad: true,
    ...
    columns: [
      ...
      },
      {
        ...
        render(record, extra) {
          var html = "Rp." + numeral(record.pengeluaran).format("0,0");
    ...
    onLoad: function (event) {
      ...
      var interval = setInterval(function () {
        ...
        $("#pembelian").html("Pembelian : Rp."+numeral(total.grand_total).format("0,0"))
        $("#terjual").html('Total : '+numeral(total.terjual).format("0,0") + ' item')
