...
function showLabel()
{
  ...
  $("#table").html(`
  <table id="cetak" style="width:80mm;margin-left:${marginLeft}mm;margin-top:${marginTop}mm" class="table tbbarcode text-sm table-sm">
    <tbody>
    </tbody>
  </table>`)
  ...
  for (let j = 0; j < jumlah; j++) {
      ...
      $("#cetak > tbody").append(`
      <tr>
      <td style="width:55mm;height:${height}cm;;padding-left:1mm;padding-right:1mm;padding-top:${top}mm;padding-bottom:${bottom}mm">${barcode1}</td>
      <td style="width:55mm;height:${height}cm;padding-left:1mm;padding-right:1mm;padding-top:${top}mm;padding-bottom:${bottom}mm">${barcode2}</td>
      </tr>
      `)
