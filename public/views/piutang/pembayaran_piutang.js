...
var config_barang = {
  grid: {
    ...
    header: header,
    url: {
      get :api_url + "api/piutang/pembayaran",
    ...
    columns: [
      ...
      },
      {
        ...
        size: '80px',
        render(record, extra) {
        var html = '<a style="padding:5px" class="btn btn-xs btn-default" href="javascript:detailPiutang(\''+record.faktur+'\',\''+record.keterangan+'\')"><i class="fa fa-info-circle "></i> Detail</a>';
        return html;
        }
    },
      {
        ...
        size: '80px',
        render(record, extra) {
        var html = '<a style="padding:5px" class="btn btn-xs btn-default" href="javascript:popupSelesai(\''+record.faktur+'\',\''+record.keterangan+'\')"><i class="fa fa-print "></i> Cetak</a>';
        return html;
        }
    },
    ],
