...
data += setText(numeral(getFaktur.meta.total).format("),0"),15,"r");
data +="\n"
data += setText("DIBAYAR :",25,"r");
data += setText(numeral(getFaktur.meta.dibayar).format("),0"),15,"r");
data +="\n"
data += setText("KEMBALI :",25,"r");
data += setText(numeral(getFaktur.meta.kembali).format("),0"),15,"r");
data +="\n"
data +="\n"
data += spacer.repeat(lebar) +"\n"
