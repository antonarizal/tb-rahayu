  ...
  grid: {
    ...
    columns: [
      ...
      },
      {
        ...
        size: '150px',
        render(record, extra) {
        var html = '<a style="padding:5px" class="btn btn-xs btn-default" href="javascript:detailPenjualan(\''+record.id+'\')"><i class="fa fa-info-circle "></i> Detail</a> <a style="padding:5px" class="btn btn-xs btn-default" href="javascript:returPenjualan(\''+record.id+'\')"><i class="fa fa-reply"></i> Retur</a>';
        return html;
        }
    },
    ],
    onLoad: function (event) {
      ...
      var interval = setInterval(function () {
        ...
        $("#terjual").html('Terjual : '+numeral(total.terjual).format("0,0.00") + ' item')
