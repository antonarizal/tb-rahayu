function detailPenjualan(id) {
    ...
    grid_mode: {
      ...
      toolbar: {
        items: [
          ...
          },
          {
            ...
            html: function (item) {
              var html =
                '<div style="padding: 3px 10px;font-weight:normal;"><span id="faktur"></span><input id="fakturPj" type="hidden"></div>';
              return html;
            },
          },
          //   { type: "spacer" },
      ...
      columns: [
        ...
        },
        {
          ...
          searchable: false,
          render(record, extra) {
            var html = numeral(record.qty).format("0,0.00");
      ...
      onLoad: function (event) {
        ...
        var records = event.xhr.responseJSON.records;
        console.log(faktur);
        var timesRun = 0;
  ...
  $(function () {
    ...
    var cart = {
      ...
      nama_barang:
        '<input class="w2ui-input" style="width:100%" id="cari" onKeyup="cari()"><span id="description" style="display:none"></span><input type="hidden" value="" id="description2">',
      harga:
        '<input class="w2ui-input" style="width:100%" value="0" id="coli" onKeyup="setColi(this)">',
      ...
      satuan:
        '<select id="selectSatuan" style="display:none" onChange="selectSatuan()"><option value="">pilih</option></select><input readonly class="w2ui-input" style="width:100%" value="" id="satuan" onKeyup="setSatuan(this)"><input type="hidden" value="" id="satuan2">',
      total:
        '<input readonly class="w2ui-input" style="width:100%" value="0.00" id="qty" onKeyup="setQty()">',
    };
