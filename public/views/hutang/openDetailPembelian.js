function detailPembelian(id) {
  ...
  const config_barang = {
    layout_mode: {
      ...
      panels: [
        ...
        '<span id="item_terjual"></span> <span style="float:right" id="pembelian"></span>' +
        '</div>'
       },
      ],
    },
    ...
    //   url: server_url + "api/pembelian/detail/" + id,
      ...
      onLoad: function (event) {
        ...
        var interval = setInterval(function () {
          ...
          $("#pembelian").html('Total : Rp.'+numeral(faktur.pemasukan).format('0,0'));
  ...
  $(function () {
    ...
    w2ui[grid_r].url = server_url + "api/pembelian/detail/"+id;
    w2ui[grid_r].reload();
